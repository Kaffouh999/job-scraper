    ...
    public static void getNfjData(String nfjUrl) {
        ...
        try {
            ...
            if (Objects.equals(nfjWebsite.select("nfj-postings-list > div.list-title-wrapper > div.list-title > h2").text(), "Offers of the day")) {
                JOptionPane.showMessageDialog(null, "No offers found on nofluffjobs.com", "Warning", JOptionPane.WARNING_MESSAGE);
        ...
        public static void getJjitData(String jjitUrl){
            ...
            try {
                ...
                if (jobOffers.isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(null, "No offers found on justjoinit.com", "Warning", JOptionPane.WARNING_MESSAGE);
